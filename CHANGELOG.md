...
### Fixed
- Removed explicit Spring Boot starter versions for Mail and Thymeleaf, allowing Spring Boot dependency management to align compatible runtime dependencies.
